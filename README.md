...
PSmac\PSmac.psd1
PSmac\functions
PSmac\internal\functions
PSmac\internal\scripts
```
...
+ `PSmac.psd1`: The module manifest. You may need to register your public functions here, maintain the version number or declare dependencies your module uses.
