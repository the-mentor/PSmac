...
param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSmac\functions", "$global:testroot\..\PSmac\internal\functions"),
...
$CommandPath = @(
	"$global:testroot\..\PSmac\functions"
	"$global:testroot\..\PSmac\internal\functions"
)
